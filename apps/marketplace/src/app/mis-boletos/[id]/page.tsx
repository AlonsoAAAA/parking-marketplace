          ...
          <div className="p-6 md:p-8 space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-100 text-amber-900 rounded-2xl p-4 flex items-start gap-3 shadow-sm text-xs">
              ...
              <p className="leading-relaxed m-0">
                <span className="font-extrabold uppercase text-amber-950">Política de reembolso:</span> Reembolso total disponible hasta 24 horas antes del evento. Cancelaciones posteriores no serán procesadas.
              </p>
            </div>
